...
export const SCREENS: Record<JobId, Record<string, ComputerBeat>> = {
  ...
  "account-research": {
    ...
    m3: {
      ...
      host: "docs.google.com",
      path: "/document/acme-account-brief",
    ...
    m4: {
      ...
      host: "docs.google.com",
      path: "/document/acme-account-sources",
    ...
    m6: {
      ...
      host: "docs.google.com",
      path: "/document/acme-account-page",
      title: "Acme account page",
      site: "page",
      tabs: [publicWeb, docs, linkedin, gmail],
    },
    m7: {
