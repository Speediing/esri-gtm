...
const ROWS: { label: string; values: string[] }[] = [
  ...
  },
  {
    ...
    values: [
      "Work arrives, and it can start without a prompt",
      "You assign a task",
  ...
  },
  {
    label: "What you get",
    values: [
      "A team of agents that keeps work moving",
  ...
  return (
    <section id="compare" className="compare">
      ...
      <p className="section-lede">
        A team of agents runs in the cloud and can start work without waiting
        for a prompt.
      </p>
